...
function onKeyEvent(keyCode, pressed) {
    ...
    if (gameState == STATE_MENU) {
        ...
        // Uncomment below to enable debug shortcuts:
        // 'g' for godmode, 'n' for noclip, '1'/'2' for zoom, shift for fast
        // if (keyCode == 16) {
        //     debugInfo.fast = (pressed != 0)
        // }
        // if (pressed != 0) {
        //     if (keyCode == 49 || keyCode == 50) {
        //         debugInfo.camZoom = (keyCode == 50 ? .7 : 3)
        //     }
        //     else if (keyCode == 71) {
        //         debugInfo.godmode = !debugInfo.godmode
        //     }
        //     else if (keyCode == 78) {
        //         debugInfo.noclip = !debugInfo.noclip
        //     }
        //     else {
        //         return
        //     }
