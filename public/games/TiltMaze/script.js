...
// Theme management
function initTheme() {
    const savedTheme = localStorage.getItem('mazeTheme') || 'light';
    if (savedTheme === 'dark') {
...
function toggleFullscreen() {
    if (!document.fullscreenElement && !document.webkitFullscreenElement &&
        ...
        // Enter fullscreen
        if (centerElement.requestFullscreen) {
            centerElement.requestFullscreen();
        } else if (centerElement.webkitRequestFullscreen) {
            centerElement.webkitRequestFullscreen();
        } else if (centerElement.mozRequestFullScreen) {
            centerElement.mozRequestFullScreen();
